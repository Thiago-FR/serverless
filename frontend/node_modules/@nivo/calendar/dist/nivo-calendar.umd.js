(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nivo/core'), require('@nivo/legends'), require('react'), require('react/jsx-runtime'), require('@nivo/tooltip'), require('d3-time-format'), require('d3-scale'), require('lodash/range'), require('lodash/memoize'), require('lodash/isDate'), require('d3-time')) :
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/core', '@nivo/legends', 'react', 'react/jsx-runtime', '@nivo/tooltip', 'd3-time-format', 'd3-scale', 'lodash/range', 'lodash/memoize', 'lodash/isDate', 'd3-time'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global.nivo, global.React, global['react/jsx-runtime'], global.nivo, global.d3, global.d3, global['lodash/range'], global['lodash/memoize'], global['lodash/isDate'], global.d3));
}(this, (function (exports, core, legends, React, jsxRuntime, tooltip, d3TimeFormat, d3Scale, _range, _memoize, _isDate, d3Time) { 'use strict';

  _range = _range && Object.prototype.hasOwnProperty.call(_range, 'default') ? _range['default'] : _range;
  _memoize = _memoize && Object.prototype.hasOwnProperty.call(_memoize, 'default') ? _memoize['default'] : _memoize;
  ...
  var CalendarDay = React.memo(function (_ref) {
    ...
    var handleMouseEnter = React.useCallback(function (event) {
      ...
      showTooltipFromEvent(React.createElement(tooltip$1, _objectSpread2({}, formatedData)), event);
  ...
  var InnerCalendar = function InnerCalendar(_ref) {
    var partialMargin = _ref.margin,
        ...
        legends$1 = _ref$legends === void 0 ? calendarDefaultProps.legends : _ref$legends,
        _ref$role = _ref.role,
    ...
    return jsxRuntime.jsxs(core.SvgWrapper, {
      ...
      children: [days.map(function (d) {
        return jsxRuntime.jsx(CalendarDay, {
          data: d,
          x: d.x,
          y: d.y,
          size: d.size,
        ...
        return jsxRuntime.jsx(CalendarMonthPath, {
          path: m.path,
          borderWidth: monthBorderWidth,
          borderColor: monthBorderColor
        }, m.date.toString());
      }), jsxRuntime.jsx(CalendarMonthLegends, {
        months: monthLegends,
        legend: monthLegend,
        theme: theme
      }), jsxRuntime.jsx(CalendarYearLegends, {
        years: yearLegends,
        legend: yearLegend,
        theme: theme
  ...
  var Calendar = function Calendar(_ref2) {
    ...
    return jsxRuntime.jsx(core.Container, {
      ...
      theme: theme,
      children: jsxRuntime.jsx(InnerCalendar, _objectSpread2({
        isInteractive: isInteractive
      }, props))
    });
  };
  ...
  function computeGrid(_ref2) {
    var startDate = _ref2.startDate,
        date = _ref2.date,
        direction = _ref2.direction;
    var firstWeek = d3Time.timeWeek.count(startDate, date);
  ...
  var computeCellPositions = function computeCellPositions(_ref3) {
    ...
    var dateRange = d3Time.timeDays(startDate, endDate).map(function (dayDate) {
      return {
        date: dayDate,
  ...
  var computeTotalDays = function computeTotalDays(_ref6) {
    ...
    return startDate.getDay() + d3Time.timeDay.count(startDate, endDate);
  };

  var TimeRangeDay = React.memo(function (_ref) {
    var data = _ref.data,
        x = _ref.x,
        _ref$ry = _ref.ry,
  ...
  var InnerTimeRange = function InnerTimeRange(_ref) {
    var partialMargin = _ref.margin,
        ...
        onMouseMove = _ref.onMouseMove,
        _ref$legends = _ref.legends,
        legends$1 = _ref$legends === void 0 ? timeRangeDefaultProps.legends : _ref$legends,
        _ref$role = _ref.role,
    ...
    return jsxRuntime.jsxs(core.SvgWrapper, {
      ...
      children: [weekdayLegends.map(function (legend) {
        ...
        return jsxRuntime.jsx(TimeRangeDay, {
          data: d,
          x: d.coordinates.x,
          rx: dayRadius,
          y: d.coordinates.y,
  ...
  var TimeRange = function TimeRange(_ref2) {
    ...
    return jsxRuntime.jsx(core.Container, {
      ...
      renderWrapper: renderWrapper,
      theme: theme,
      children: jsxRuntime.jsx(InnerTimeRange, _objectSpread2({
        isInteractive: isInteractive
      }, props))
    });
  };
  ...
  var ResponsiveTimeRange = function ResponsiveTimeRange(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(TimeRange, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveCalendar = function ResponsiveCalendar(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(Calendar, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var findDayUnderCursor = function findDayUnderCursor(event, canvasEl, days, size, dayBorderWidth, margin) {
    ...
    return days.find(function (day) {
      return 'value' in day && core.isCursorInRect(day.x + margin.left - dayBorderWidth / 2, day.y + margin.top - dayBorderWidth / 2, size + dayBorderWidth, size + dayBorderWidth, x, y);
    });
  };

  var InnerCalendarCanvas = React.memo(function (_ref) {
    var partialMargin = _ref.margin,
        width = _ref.width,
        height = _ref.height,
        ...
        _ref$tooltip = _ref.tooltip,
        tooltip$1 = _ref$tooltip === void 0 ? calendarCanvasDefaultProps.tooltip : _ref$tooltip,
        onClick = _ref.onClick,
        onMouseEnter = _ref.onMouseEnter,
        onMouseLeave = _ref.onMouseLeave,
        onMouseMove = _ref.onMouseMove,
        _ref$legends = _ref.legends,
        legends$1 = _ref$legends === void 0 ? calendarCanvasDefaultProps.legends : _ref$legends;
    ...
    }, [canvasEl, innerHeight, innerWidth, outerWidth, outerHeight, pixelRatio, margin, days, dayBorderColor, dayBorderWidth, colorScale, yearLegend, yearLegends, monthLegend, monthLegends, legends$1, theme, formatLegend, colorScaleFn]);
    ...
    }, [canvasEl, currentDay, margin, days, setCurrentDay, formatValue, dayBorderWidth, showTooltipFromEvent, hideTooltip, onMouseEnter, onMouseMove, onMouseLeave, tooltip$1]);
  ...
  var CalendarCanvas = function CalendarCanvas(_ref2) {
    ...
    return jsxRuntime.jsx(core.Container, {
      ...
      renderWrapper: renderWrapper,
      theme: theme,
      children: jsxRuntime.jsx(InnerCalendarCanvas, _objectSpread2({
        isInteractive: isInteractive
      }, props))
    });
  };
  ...
  var ResponsiveCalendarCanvas = function ResponsiveCalendarCanvas(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(CalendarCanvas, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  exports.computeCellPositions = computeCellPositions;
  exports.computeCellSize = computeCellSize$1;
  ...
  exports.computeMonthLegends = computeMonthLegends;
  exports.computeTotalDays = computeTotalDays;
  exports.computeWeekdays = computeWeekdays;
  exports.computeYearLegendPositions = computeYearLegendPositions;
  exports.timeRangeDefaultProps = timeRangeDefaultProps;
