import { memo, useMemo, useState, createElement, Fragment as Fragment$1, useRef, useEffect, useCallback } from 'react';
...
var ChordRibbonTooltip = memo(function (_ref) {
  ...
  return jsx(TableTooltip, {
    ...
    }, "id"), ribbon.source.formattedValue], [jsx(Chip, {
...
var Chord = function Chord(_ref) {
  ...
  if (enableLabel === true) {
    layerById.labels = jsx("g", {
      transform: "translate(".concat(center[0], ", ").concat(center[1], ")"),
      children: jsx(ChordLabels, {
        arcs: arcs,
...
var ChordCanvas = memo(function (_ref2) {
  ...
  var handleMouseHover = useCallback(function (event) {
    ...
    if (arc) {
      setCurrentArc(arc);
      showTooltipFromEvent(createElement(arcTooltip, {
        arc: arc
      }), event);
  ...
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(Chord$1, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveChordCanvas = function ResponsiveChordCanvas(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(ChordCanvas$1, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
