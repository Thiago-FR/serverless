(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/colors'), require('@nivo/legends'), require('prop-types'), require('@nivo/tooltip'), require('react/jsx-runtime'), require('d3-shape'), require('d3-chord'), require('lodash/mapValues'), require('react-motion'), require('@nivo/arcs')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/colors', '@nivo/legends', 'prop-types', '@nivo/tooltip', 'react/jsx-runtime', 'd3-shape', 'd3-chord', 'lodash/mapValues', 'react-motion', '@nivo/arcs'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global.PropTypes, global.nivo, global['react/jsx-runtime'], global.d3, global.d3, global['lodash/mapValues'], global.ReactMotion, global.nivo));
}(this, (function (exports, react, core, colors, legends, PropTypes, tooltip, jsxRuntime, d3Shape, d3Chord, mapValues, reactMotion, arcs) { 'use strict';
  ...
  var ChordRibbonTooltip = react.memo(function (_ref) {
    ...
    return jsxRuntime.jsx(tooltip.TableTooltip, {
      theme: theme,
      rows: [[jsxRuntime.jsx(tooltip.Chip, {
        color: ribbon.source.color
      }, "chip"), jsxRuntime.jsx("strong", {
        children: ribbon.source.label
      }, "id"), ribbon.source.formattedValue], [jsxRuntime.jsx(tooltip.Chip, {
    ...
    if (animate !== true) {
      return jsxRuntime.jsx("g", {
        children: ribbons.map(function (ribbon) {
          return jsxRuntime.jsx(ChordRibbon, {
            ribbon: ribbon,
            ribbonGenerator: ribbonGenerator,
  ...
  var ChordArcs = react.memo(function (_ref) {
    ...
    if (animate !== true) {
      return arcs.map(function (arc) {
        return jsxRuntime.jsx(ChordArc, {
          arc: arc,
          arcGenerator: arcGenerator,
  ...
  var Chord = function Chord(_ref) {
    ...
    var layerById = {
      ribbons: jsxRuntime.jsx("g", {
        transform: "translate(".concat(center[0], ", ").concat(center[1], ")"),
        children: jsxRuntime.jsx(ChordRibbons, {
          ribbons: ribbons,
          ribbonGenerator: ribbonGenerator,
      ...
      arcs: jsxRuntime.jsx("g", {
        transform: "translate(".concat(center[0], ", ").concat(center[1], ")"),
        children: jsxRuntime.jsx(ChordArcs, {
          arcs: arcs,
          arcGenerator: arcGenerator,
      ...
      labels: null,
      legends: jsxRuntime.jsx(react.Fragment, {
    ...
    if (enableLabel === true) {
      layerById.labels = jsxRuntime.jsx("g", {
        transform: "translate(".concat(center[0], ", ").concat(center[1], ")"),
        children: jsxRuntime.jsx(ChordLabels, {
          arcs: arcs,
    ...
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(Chord$1, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveChordCanvas = function ResponsiveChordCanvas(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(ChordCanvas$1, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
