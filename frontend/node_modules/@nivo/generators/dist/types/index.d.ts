...
export declare const generateLibTree: (name?: string, limit?: number | null | undefined, children?: (string | (string | (string | (string | string[][])[][])[][])[][])[][]) => Record<string, unknown>;
