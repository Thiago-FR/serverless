...
var getNodeTargets = function getNodeTargets(id, links, currentPath) {
  var targets = links.filter(function (_ref) {
    ...
    if (currentPath === null || currentPath === void 0 ? void 0 : currentPath.includes(target)) {
...
var generateDrinkStats = function generateDrinkStats() {
  ...
  range(xSize).forEach(function () {
    ...
    types.forEach(function (id) {
      ...
      (_data$find = data.find(function (d) {
        return d.id === id;
      })) === null || _data$find === void 0 ? void 0 : _data$find.data.push({
        color: randColor$1(),
        x: x,
        y: rand()
      });
...
var generateOrderedDayCounts = function generateOrderedDayCounts(from, to) {
...
var generateDayCounts = function generateDayCounts(from, to) {
  ...
  var days = generateOrderedDayCounts(from, to);
...
var generateLibTree = function generateLibTree() {
  ...
  if ((children === null || children === void 0 ? void 0 : children.length) > 0) {
    tree.children = range(limit).map(function (_, i) {
      var _leaf$;

      var leaf = children[i];
      return generateLibTree(leaf[0], null, (_leaf$ = leaf[1]) !== null && _leaf$ !== void 0 ? _leaf$ : []);
    });
  } else {
