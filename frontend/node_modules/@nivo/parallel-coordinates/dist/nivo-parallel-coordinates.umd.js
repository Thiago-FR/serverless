(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nivo/core'), require('@nivo/axes'), require('prop-types'), require('@nivo/colors'), require('react'), require('d3-shape'), require('d3-scale'), require('@react-spring/web'), require('@nivo/tooltip'), require('react/jsx-runtime')) :
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/core', '@nivo/axes', 'prop-types', '@nivo/colors', 'react', 'd3-shape', 'd3-scale', '@react-spring/web', '@nivo/tooltip', 'react/jsx-runtime'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global.nivo, global.PropTypes, global.nivo, global.React, global.d3, global.d3, global['@react-spring/web'], global.nivo, global['react/jsx-runtime']));
}(this, (function (exports, core, axes, PropTypes, colors, react, d3Shape, d3Scale, web, tooltip, jsxRuntime) { 'use strict';
  ...
  var ParallelCoordinatesLineTooltip = function ParallelCoordinatesLineTooltip(_ref) {
    ...
    return jsxRuntime.jsx(tooltip.TableTooltip, {
      rows: variables.map(function (variable) {
        return [variable.key, jsxRuntime.jsx("strong", {
          children: data[variable.key]
        })];
      })
    });
  };
  ...
  var ParallelCoordinatesLine = function ParallelCoordinatesLine(_ref) {
    ...
    var handleMouseHover = react.useCallback(function (event) {
      showTooltipFromEvent(jsxRuntime.jsx(ParallelCoordinatesLineTooltip$1, {
        data: data,
        variables: variables
      }), event);
    }, [data, variables]);
  ...
  var ParallelCoordinates = function ParallelCoordinates(_ref) {
    ...
    var axes$1 = variablesWithScale.map(function (variable) {
      return jsxRuntime.jsx(axes.Axis, {
    ...
    return jsxRuntime.jsxs(core.SvgWrapper, {
      ...
      margin: margin,
      role: role,
      children: [axesPlan === 'background' && axes$1, dataWithPoints.map(function (datum) {
        return jsxRuntime.jsx(ParallelCoordinatesLine$1, {
          data: datum,
          variables: variables,
          lineGenerator: lineGenerator,
          points: datum.points,
  ...
  var ResponsiveParallelCoordinates = function ResponsiveParallelCoordinates(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WrappedParallelCoordinates, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveParallelCoordinatesCanvas = function ResponsiveParallelCoordinatesCanvas(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WrappedParallelCoordinatesCanvas, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
