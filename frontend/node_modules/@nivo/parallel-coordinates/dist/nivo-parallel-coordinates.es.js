...
var ParallelCoordinatesLineTooltip = function ParallelCoordinatesLineTooltip(_ref) {
  ...
  return jsx(TableTooltip, {
    rows: variables.map(function (variable) {
      return [variable.key, jsx("strong", {
...
var ParallelCoordinatesLine = function ParallelCoordinatesLine(_ref) {
  ...
  var handleMouseHover = useCallback(function (event) {
    showTooltipFromEvent(jsx(ParallelCoordinatesLineTooltip$1, {
      data: data,
      variables: variables
    }), event);
  }, [data, variables]);
...
var ParallelCoordinates = function ParallelCoordinates(_ref) {
  ...
  return jsxs(SvgWrapper, {
    ...
    margin: margin,
    role: role,
    children: [axesPlan === 'background' && axes, dataWithPoints.map(function (datum) {
      return jsx(ParallelCoordinatesLine$1, {
        data: datum,
        variables: variables,
        lineGenerator: lineGenerator,
        points: datum.points,
...
var ResponsiveParallelCoordinates = function ResponsiveParallelCoordinates(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WrappedParallelCoordinates, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveParallelCoordinatesCanvas = function ResponsiveParallelCoordinatesCanvas(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WrappedParallelCoordinatesCanvas, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
