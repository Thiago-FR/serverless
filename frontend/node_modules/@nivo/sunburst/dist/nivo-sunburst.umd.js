(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('@nivo/arcs'), require('@nivo/tooltip'), require('react/jsx-runtime'), require('d3-hierarchy'), require('lodash/cloneDeep'), require('lodash/sortBy'), require('@nivo/colors')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', '@nivo/arcs', '@nivo/tooltip', 'react/jsx-runtime', 'd3-hierarchy', 'lodash/cloneDeep', 'lodash/sortBy', '@nivo/colors'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.nivo, global.nivo, global['react/jsx-runtime'], global.d3, global['lodash/cloneDeep'], global['lodash/sortBy'], global.nivo));
}(this, (function (exports, react, core, arcs, tooltip, jsxRuntime, d3Hierarchy, cloneDeep, sortBy, colors) { 'use strict';
  ...
  var Sunburst = function Sunburst(_ref2) {
    ...
    return jsxRuntime.jsx(core.Container, {
      ...
      theme: theme,
      children: jsxRuntime.jsx(InnerSunburst, _objectSpread2({
        isInteractive: isInteractive
      }, otherProps))
    });
  };
    ...
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(Sunburst, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
