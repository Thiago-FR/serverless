...
declare type InnerCirclePackingHtmlProps<RawDatum> = Partial<Omit<CirclePackingHtmlProps<RawDatum>, 'data' | 'width' | 'height' | 'isInteractive' | 'animate' | 'motionConfig'>> & Pick<CirclePackingHtmlProps<RawDatum>, 'data' | 'width' | 'height' | 'isInteractive'>;
...
export declare const CirclePackingHtml: <RawDatum>({ theme, isInteractive, animate, motionConfig, ...otherProps }: Partial<Omit<CirclePackingHtmlProps<RawDatum>, "height" | "width" | "data">> & Pick<CirclePackingHtmlProps<RawDatum>, "height" | "width" | "data">) => JSX.Element;
export {};
