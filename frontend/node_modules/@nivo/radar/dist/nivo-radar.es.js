...
import { useTheme, useMotionConfig, useAnimatedPath, positionFromAngle, radiansToDegrees, usePropertyAccessor, DotsItem, useValueFormatter, bindDefs, useCurveInterpolation, Container, useDimensions, SvgWrapper, ResponsiveWrapper } from '@nivo/core';
...
var useRadar = function useRadar(_ref) {
  ...
  var _useMemo = useMemo(function () {
    ...
    var boundDefs = bindDefs(defs, keyData, fill);
