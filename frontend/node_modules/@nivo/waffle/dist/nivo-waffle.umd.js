(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('lodash/partial'), require('react-motion'), require('@nivo/recompose'), require('@nivo/core'), require('@nivo/legends'), require('prop-types'), require('@nivo/colors'), require('react/jsx-runtime'), require('lodash/range'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'lodash/partial', 'react-motion', '@nivo/recompose', '@nivo/core', '@nivo/legends', 'prop-types', '@nivo/colors', 'react/jsx-runtime', 'lodash/range', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global['lodash/partial'], global.ReactMotion, global.nivo, global.nivo, global.nivo, global.PropTypes, global.nivo, global['react/jsx-runtime'], global['lodash/range'], global.nivo));
}(this, (function (exports, react, partial, reactMotion, recompose, core, legends, PropTypes, colors, jsxRuntime, range, tooltip) { 'use strict';
  ...
  var Waffle = function (_Component) {
    ...
    function Waffle() {
      ...
      _this.handleCellHover = function (showTooltip, cell, event) {
        ...
        setCurrentCell(cell);
        if (!cell.data) return;
        showTooltip(jsxRuntime.jsx(WaffleCellTooltip, {
    ...
    _createClass(Waffle, [{
      ...
      value: function render() {
        ...
        return jsxRuntime.jsx(core.LegacyContainer, {
          ...
          children: function children(_ref) {
            ...
            if (animate === true) {
              ...
              cellsRender = jsxRuntime.jsx(reactMotion.TransitionMotion, {
                ...
                children: function children(interpolatedStyles) {
                  ...
                  return jsxRuntime.jsx(react.Fragment, {
                    children: computedCells.map(function (cell) {
              ...
              cellsRender = jsxRuntime.jsx(react.Fragment, {
                children: computedCells.map(function (cell) {
                  return react.createElement(cellComponent, {
                    key: cell.position,
                    position: cell.position,
    ...
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(Waffle$1, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveWaffleHtml = function ResponsiveWaffleHtml(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WaffleHtml$1, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveWaffleCanvas = function ResponsiveWaffleCanvas(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WaffleCanvas$1, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
