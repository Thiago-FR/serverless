...
var Waffle = function (_Component) {
  ...
  function Waffle() {
    ...
    _this.handleCellHover = function (showTooltip, cell, event) {
      ...
      setCurrentCell(cell);
      if (!cell.data) return;
      showTooltip(jsx(WaffleCellTooltip, {
      ...
      return jsx(LegacyContainer, {
        ...
        children: function children(_ref) {
          ...
          if (animate === true) {
            ...
            cellsRender = jsx(TransitionMotion, {
  ...
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(Waffle$1, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveWaffleHtml = function ResponsiveWaffleHtml(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WaffleHtml$1, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveWaffleCanvas = function ResponsiveWaffleCanvas(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WaffleCanvas$1, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
