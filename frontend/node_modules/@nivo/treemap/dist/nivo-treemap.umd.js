(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@nivo/core'), require('prop-types'), require('@nivo/colors'), require('react'), require('@react-spring/web'), require('react/jsx-runtime'), require('lodash/get'), require('lodash/omit'), require('lodash/cloneDeep'), require('lodash/startCase'), require('d3-hierarchy'), require('@nivo/tooltip')) :
  typeof define === 'function' && define.amd ? define(['exports', '@nivo/core', 'prop-types', '@nivo/colors', 'react', '@react-spring/web', 'react/jsx-runtime', 'lodash/get', 'lodash/omit', 'lodash/cloneDeep', 'lodash/startCase', 'd3-hierarchy', '@nivo/tooltip'], factory) :
  (global = global || self, factory(global.nivo = global.nivo || {}, global.nivo, global.PropTypes, global.nivo, global.React, global['@react-spring/web'], global['react/jsx-runtime'], global['lodash/get'], global['lodash/omit'], global['lodash/cloneDeep'], global['lodash/startCase'], global.d3, global.nivo));
}(this, (function (exports, core, PropTypes, colors, react, web, jsxRuntime, get, omit, cloneDeep, startCase, d3Hierarchy, tooltip) { 'use strict';
  ...
  var TreeMapNode = function TreeMapNode(_ref) {
    ...
    return jsxRuntime.jsxs(web.animated.g, {
      ...
      children: [jsxRuntime.jsx(web.animated.rect, {
      ...
      }), showLabel && jsxRuntime.jsx(web.animated.text, {
        textAnchor: "middle",
        ...
        children: node.label
      }), showParentLabel && jsxRuntime.jsx(web.animated.text, {
        dominantBaseline: "central",
        style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
  ...
  var TreeMapHtmlNode = function TreeMapHtmlNode(_ref) {
    ...
    var showLabel = enableLabel && node.isLeaf && (labelSkipSize === 0 || Math.min(node.width, node.height) > labelSkipSize);
    var showParentLabel = enableParentLabel && node.isParent;
    return jsxRuntime.jsxs(web.animated.div, {
      ...
      children: [jsxRuntime.jsx(web.animated.div, {
        ...
        onMouseLeave: node.onMouseLeave,
        onClick: node.onClick
      }), showLabel && jsxRuntime.jsx(web.animated.span, {
        style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
          position: 'absolute',
          display: 'flex',
          top: -5,
        ...
        children: node.label
      }), showParentLabel && jsxRuntime.jsx(web.animated.span, {
        style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
          position: 'absolute',
          display: 'flex',
  ...
  var useInteractiveTreeMapNodes = function useInteractiveTreeMapNodes(nodes, _ref4) {
    ...
    var showTooltip = react.useCallback(function (node, event) {
      showTooltipFromEvent(jsxRuntime.jsx(TreeMapNodeTooltip$1, {
        node: node,
        tooltip: tooltip$1
      }), event, 'left');
  ...
  var TreeMapNodes = function TreeMapNodes(_ref) {
    ...
    var transition = web.useTransition(interactiveNodes, {
  ...
  var TreeMap = function TreeMap(_ref) {
    ...
    return jsxRuntime.jsx(core.SvgWrapper, {
      ...
      defs: boundDefs,
      role: role,
      children: jsxRuntime.jsx(TreeMapNodes$1, {
        nodes: nodes,
  ...
  var ResponsiveTreeMap = function ResponsiveTreeMap(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WrappedTreeMap, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveTreeMapHtml = function ResponsiveTreeMapHtml(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WrappedTreeMapHtml, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
  ...
  var ResponsiveTreeMapCanvas = function ResponsiveTreeMapCanvas(props) {
    return jsxRuntime.jsx(core.ResponsiveWrapper, {
      children: function children(_ref) {
        var width = _ref.width,
            height = _ref.height;
        return jsxRuntime.jsx(WrappedTreeMapCanvas, _objectSpread2({
          width: width,
          height: height
        }, props));
      }
