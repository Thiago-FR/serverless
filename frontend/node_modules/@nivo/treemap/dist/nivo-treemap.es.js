...
import { memo, useMemo, useCallback, createElement, useRef, useEffect } from 'react';
...
var TreeMapNode = function TreeMapNode(_ref) {
  ...
  return jsxs(animated.g, {
    ...
    children: [jsx(animated.rect, {
      ...
      children: node.label
    }), showParentLabel && jsx(animated.text, {
      dominantBaseline: "central",
      style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
...
var TreeMapHtmlNode = function TreeMapHtmlNode(_ref) {
  ...
  return jsxs(animated.div, {
    ...
    children: [jsx(animated.div, {
      ...
      children: node.label
    }), showParentLabel && jsx(animated.span, {
      style: _objectSpread2(_objectSpread2({}, theme.labels.text), {}, {
        position: 'absolute',
        display: 'flex',
...
var useInteractiveTreeMapNodes = function useInteractiveTreeMapNodes(nodes, _ref4) {
  ...
  var showTooltip = useCallback(function (node, event) {
    showTooltipFromEvent(jsx(TreeMapNodeTooltip$1, {
      node: node,
      tooltip: tooltip
    }), event, 'left');
...
var TreeMapNodes = function TreeMapNodes(_ref) {
  ...
  var transition = useTransition(interactiveNodes, {
...
var ResponsiveTreeMap = function ResponsiveTreeMap(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WrappedTreeMap, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveTreeMapHtml = function ResponsiveTreeMapHtml(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WrappedTreeMapHtml, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
...
var ResponsiveTreeMapCanvas = function ResponsiveTreeMapCanvas(props) {
  return jsx(ResponsiveWrapper, {
    children: function children(_ref) {
      var width = _ref.width,
          height = _ref.height;
      return jsx(WrappedTreeMapCanvas, _objectSpread2({
        width: width,
        height: height
      }, props));
    }
